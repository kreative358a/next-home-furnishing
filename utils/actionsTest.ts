...
export async function addToCartActionTest(prevState: any, formData: FormData) {
  const user = await getAuthUser();
  // return {message: 'product added to the cart'}
  try {
...
export async function addToCartActionTestOne(
  prevState: any,
  formData: FormData
) {
  const user = await getAuthUser();
...
export async function addToCartActionTestSinglePage(
  prevState: any,
  formData: FormData
) {
  const user = await getAuthUser();
