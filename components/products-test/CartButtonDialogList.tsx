...
import CartButtonDialogListContent from "./CartButtonDialogListContent";

async function CartButtonDialogList({ productId }: { productId: string }) {
    ...
    <Dialog>
      ...
      >
        ...
        <div className="pl-2 pr-0 sm:p-4 dialog-content-background max-h-[760px] bg-muted/20 hover:bg-muted/40 text-secondary-foreground">
          <CartButtonDialogListContent productId={productId} />
          {/* </ScrollArea> */}
        </div>
      </DialogContent>
    </Dialog>
...
export default CartButtonDialogList;
