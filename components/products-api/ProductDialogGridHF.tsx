            ...
            /> */}
                <div className="w-100% h-auto ml-[-28px] sm:mx-auto">
                  <SwiperProduct
                    ...
                    className=" w-[400px] max-w-[96%] h-[400px] max-h-[96%] sm:w-[32rem] sm:h-[32rem] xl:w-[34rem] xl:h-[34rem] p-4 space-x-4 bg-slate-700/60 rounded-box"
                  >
                    ...
                    {productPhotos.map((photo, index) => {
                      return (
                        ...
                        <div className="w-[100%]" key={nanoid()}>
                          <SwiperSlideProduct key={`${photo}-${index}-grid`}>
                ...
                <div>
                  ...
                  {/* <p className="mt-6 mr-4 min-[420px]:mr-2 leading-6 text-justify">
                    productPhotos length: {productPhotos.length}, istPhotos
                    length: {listPhotos.length}
                  </p> */}
                  {/* COLORS */}
                  <div className="mt-3">
                        ...
                        return (
                          ...
                          >
                            <button
                              ...
                              className={`badge rounded-[50%] p-1 w-5 h-5 sm:w-6 sm:h-6 xl:h-7 xk:w-7 3xl:w-8 3xl:h-8 mr-2 lg:mr-4  box-shadow-around-sm ${
                                color === productColor &&
