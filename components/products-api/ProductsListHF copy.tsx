      ...
      return (
        ...
        >
          ...
          <div className="ml-0 sm:ml-16">
            <p className="capitalize font-medium text-base lg:text-lg leading-tight">
              {imageAlt.split(",")[0] || ""}
              <br />{" "}
              {`${imageAlt.split(",")[1] || ""} ${
                imageAlt.split(",")[2] || ""
            ...
            <p className="capitalize text-sm lg:text-base text-success pt-2">
              Home Furnishings
            </p>
          ...
          {/* <div>
            <ProductDialogListHF key={id} id={id} product={product} />
          </div> */}
        </div>
      );
    });
  ...
  return (
    <div className="pb-6">
      <div className="text-base md:text-lg bg-muted/80 rounded-md px-8 py-4 grid gap-x-4 gap-y-8 sm:grid-cols-2 md:grid-cols-3 items-center">
        <p className="stats text-lg lg:text-xl bg-muted/60 shadow p-2 text-center rounded-md">
          {" "}
