...
function SingleProductDialogCart({
  ...
  return (
    ...
    >
      <Button
        onClick={open}
        className="rounded-md mt-4 bg-secondary/40 py-1 px-4 text-base md:text-lg font-medium text-red-600 focus:outline-none data-[hover]:bg-secondary/60 data-[focus]:outline-1 data-[focus]:outline-white border-2 border-blue-600/50 hover:border-blue-600/80 "
      >
        details
      </Button>
      <Dialog
      ...
      >
        ...
        >
          <div className="flex min-h-full items-center justify-center p-4">
            <DialogPanel
              transition
              className="w-full min-w-[90%] rounded-xl p-6 backdrop-blur-xl duration-300 ease-out data-[closed]:transform-[scale(95%)] data-[closed]:opacity-0 bg-muted/60 hover:bg-muted/60"
            >
              <div className="mt-2">
                <Button
